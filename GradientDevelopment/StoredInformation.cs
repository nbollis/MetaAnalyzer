namespace GradientDevelopment
{
    public static class StoredInformation
    {
        ...
        public static List<RunInformation> RunInformationList = new List<RunInformation>()
        {
            ...
            // Round 8
            new( Path.Combine(GradientDevelopmentDataDirectory, "241105_FLuc_45Dig_TEAAandAA_Spike_6ug_130Pfizer10.raw"), Path.Combine(GradientDirectory, "Pfizer10.csv"), GradientDevelopmentBigSearch, "MeOH"),
            new( Path.Combine(GradientDevelopmentDataDirectory, "241105_FLuc_45Dig_TEAAandAA_Spike_6ug_210-2Pfizer11.raw"), Path.Combine(GradientDirectory, "Pfizer11.csv"), GradientDevelopmentBigSearch, "MeOH"),
            new( Path.Combine(GradientDevelopmentDataDirectory, "241105_FLuc_45Dig_TEAAandAA_Spike_12ug_290Pfizer1.raw"), Path.Combine(GradientDirectory, "Pfizer1.csv"), GradientDevelopmentBigSearch, "MeOH"),
        };
    }
