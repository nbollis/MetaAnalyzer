...
namespace GradientDevelopment.Temporary
{
    ...
    public class Ms1FeatureFile : ResultFile<Ms1Feature>, IResultFile
    {
        ...
        public override void LoadResults()
        {
            ...
            Results.ForEach(p => p.RetentionTimeApex = (p.RetentionTimeApex / 60.0).Round(2));
            Results.ForEach(p => p.RetentionTimeBegin = (p.RetentionTimeBegin / 60.0).Round(2));
            Results.ForEach(p => p.RetentionTimeEnd = (p.RetentionTimeEnd / 60.0).Round(2));
