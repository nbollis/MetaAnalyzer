...
public static class PlottingTranslators
{
    ...
    private static Dictionary<string, string> ConditionNameConversionDictionary = new()
    {
        ...
        { "MetaMorpheusWithChimeras_107_ChimericLibrary", "MetaMorpheus\u2800" },
        { "MetaMorpheusWithChimeras_107_ChimericLibrary_Rep1", "MetaMorpheus\u2800" },
        { "MetaMorpheusWithChimeras_107_ChimericLibrary_Rep2", "MetaMorpheus\u2800" },
        { "MetaMorpheusWithChimeras_107_ChimericLibrary_Rep3", "MetaMorpheus\u2800" },
        { "MetaMorpheusWithChimeras_108_ChimericLibrary", "MetaMorpheus\u2800" },
        ...
        { "MetaMorpheusNoChimeras_107_NonChimericLibrary", "MetaMorpheus No Chimeras" },
        { "MetaMorpheusNoChimeras_107_NonChimericLibrary_Rep1", "MetaMorpheus No Chimeras" },
        { "MetaMorpheusNoChimeras_107_NonChimericLibrary_Rep2", "MetaMorpheus No Chimeras" },
        { "MetaMorpheusNoChimeras_107_NonChimericLibrary_Rep3", "MetaMorpheus No Chimeras" },
        { "MetaMorpheusNoChimeras_108_NonChimericLibrary", "MetaMorpheus No Chimeras" },
        ...
        { "MetaMorpheusWithChimeras_107_NonChimericLibrary", "MetaMorpheus Chimeras (Non-chimeric library)" },
        { "MetaMorpheusWithChimeras_107_NonChimericLibrary_Rep1", "MetaMorpheus Chimeras (Non-chimeric library)" },
        { "MetaMorpheusWithChimeras_107_NonChimericLibrary_Rep2", "MetaMorpheus Chimeras (Non-chimeric library)" },
        { "MetaMorpheusWithChimeras_107_NonChimericLibrary_Rep3", "MetaMorpheus Chimeras (Non-chimeric library)" },
        { "MetaMorpheusWithChimeras_108_NonChimericLibrary", "MetaMorpheus Chimeras (Non-chimeric library)" },
