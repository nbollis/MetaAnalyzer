...
public static class PlottingTranslators
{
    static PlottingTranslators()
    {
        ColorQueue = new Queue<Color>(new[]
        {
            ...
            Color.fromKeyword(ColorKeyword.AliceBlue),
            Color.fromKeyword(ColorKeyword.AntiqueWhite),
            Color.fromKeyword(ColorKeyword.Aqua),
            Color.fromKeyword(ColorKeyword.Aquamarine),
            Color.fromKeyword(ColorKeyword.Azure),
            Color.fromKeyword(ColorKeyword.Bisque),
            Color.fromKeyword(ColorKeyword.BlanchedAlmond),
            Color.fromKeyword(ColorKeyword.BurlyWood),
            Color.fromKeyword(ColorKeyword.CadetBlue),
            Color.fromKeyword(ColorKeyword.Chartreuse),
            Color.fromKeyword(ColorKeyword.Chocolate),
            Color.fromKeyword(ColorKeyword.CornflowerBlue),
            Color.fromKeyword(ColorKeyword.Crimson),
            Color.fromKeyword(ColorKeyword.DarkGoldenRod),
            Color.fromKeyword(ColorKeyword.DarkKhaki),
            Color.fromKeyword(ColorKeyword.DarkSalmon),
            Color.fromKeyword(ColorKeyword.DarkSeaGreen),
            Color.fromKeyword(ColorKeyword.DarkSlateBlue),
            Color.fromKeyword(ColorKeyword.DarkSlateGray),
            Color.fromKeyword(ColorKeyword.DarkTurquoise),
            Color.fromKeyword(ColorKeyword.DeepPink),
            Color.fromKeyword(ColorKeyword.DeepSkyBlue),
            Color.fromKeyword(ColorKeyword.DimGray),
            Color.fromKeyword(ColorKeyword.DodgerBlue),
            Color.fromKeyword(ColorKeyword.FireBrick),
            Color.fromKeyword(ColorKeyword.FloralWhite),
            Color.fromKeyword(ColorKeyword.ForestGreen),
            Color.fromKeyword(ColorKeyword.Fuchsia),
            Color.fromKeyword(ColorKeyword.Gainsboro),
            Color.fromKeyword(ColorKeyword.GhostWhite),
            Color.fromKeyword(ColorKeyword.Gold),
            Color.fromKeyword(ColorKeyword.GoldenRod),
            Color.fromKeyword(ColorKeyword.GreenYellow),
            Color.fromKeyword(ColorKeyword.IndianRed),
            Color.fromKeyword(ColorKeyword.Ivory),
            Color.fromKeyword(ColorKeyword.Khaki),
            Color.fromKeyword(ColorKeyword.LavenderBlush),
            Color.fromKeyword(ColorKeyword.LawnGreen),
            Color.fromKeyword(ColorKeyword.LemonChiffon),
            Color.fromKeyword(ColorKeyword.LightBlue),
            Color.fromKeyword(ColorKeyword.LightCoral),
            Color.fromKeyword(ColorKeyword.LightCyan),
            Color.fromKeyword(ColorKeyword.LightGoldenRodYellow),
            Color.fromKeyword(ColorKeyword.LightGray),
            Color.fromKeyword(ColorKeyword.LightGreen),
            Color.fromKeyword(ColorKeyword.LightPink),
            Color.fromKeyword(ColorKeyword.LightSteelBlue),
            Color.fromKeyword(ColorKeyword.LightYellow),
            Color.fromKeyword(ColorKeyword.Linen),
            Color.fromKeyword(ColorKeyword.MediumBlue),
            Color.fromKeyword(ColorKeyword.MediumOrchid),
            Color.fromKeyword(ColorKeyword.MediumPurple),
            Color.fromKeyword(ColorKeyword.MediumSeaGreen),
            Color.fromKeyword(ColorKeyword.MediumSlateBlue),
            Color.fromKeyword(ColorKeyword.MediumSpringGreen),
            Color.fromKeyword(ColorKeyword.MediumTurquoise),
            Color.fromKeyword(ColorKeyword.MediumVioletRed),
            Color.fromKeyword(ColorKeyword.MidnightBlue),
            Color.fromKeyword(ColorKeyword.MintCream),
            Color.fromKeyword(ColorKeyword.MistyRose),
            Color.fromKeyword(ColorKeyword.Moccasin),
            Color.fromKeyword(ColorKeyword.NavajoWhite),
            Color.fromKeyword(ColorKeyword.OldLace),
            Color.fromKeyword(ColorKeyword.OliveDrab),
            Color.fromKeyword(ColorKeyword.OrangeRed),
            Color.fromKeyword(ColorKeyword.Orchid),
            Color.fromKeyword(ColorKeyword.PaleGoldenRod),
            Color.fromKeyword(ColorKeyword.PaleGreen),
            Color.fromKeyword(ColorKeyword.PaleTurquoise),
            Color.fromKeyword(ColorKeyword.PaleVioletRed),
            Color.fromKeyword(ColorKeyword.PapayaWhip),
            Color.fromKeyword(ColorKeyword.PeachPuff),
            Color.fromKeyword(ColorKeyword.Peru),
            Color.fromKeyword(ColorKeyword.Plum),
            Color.fromKeyword(ColorKeyword.PowderBlue),
            Color.fromKeyword(ColorKeyword.RosyBrown),
            Color.fromKeyword(ColorKeyword.RoyalBlue),
            Color.fromKeyword(ColorKeyword.SaddleBrown),
            Color.fromKeyword(ColorKeyword.Salmon),
            Color.fromKeyword(ColorKeyword.SandyBrown),
            Color.fromKeyword(ColorKeyword.SeaGreen),
            Color.fromKeyword(ColorKeyword.SeaShell),
            Color.fromKeyword(ColorKeyword.Sienna),
            Color.fromKeyword(ColorKeyword.Silver),
            Color.fromKeyword(ColorKeyword.SlateBlue),
            Color.fromKeyword(ColorKeyword.SlateGray),
            Color.fromKeyword(ColorKeyword.Snow),
            Color.fromKeyword(ColorKeyword.SpringGreen),
            Color.fromKeyword(ColorKeyword.SteelBlue),
            Color.fromKeyword(ColorKeyword.Tan),
            Color.fromKeyword(ColorKeyword.Thistle),
            Color.fromKeyword(ColorKeyword.Tomato),
            Color.fromKeyword(ColorKeyword.Violet),
            Color.fromKeyword(ColorKeyword.Wheat),
            Color.fromKeyword(ColorKeyword.WhiteSmoke),
            Color.fromKeyword(ColorKeyword.YellowGreen)
        });
    }
