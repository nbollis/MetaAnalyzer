...
public class DictionaryPool<TKey, TValue> where TKey : notnull
{
    ...
    private class DictionaryPooledObjectPolicy<TKeyItem, TValueItem>
        : PooledObjectPolicy<Dictionary<TKeyItem, TValueItem>> where TKeyItem : notnull
    {
        private int InitialCapacity { get; }
        public DictionaryPooledObjectPolicy(int initialCapacity)
        {
